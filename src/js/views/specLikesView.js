...
export const toggleSpecLikeBtn = isSpecLiked => {
    ...
    document.querySelector('.recipe__love-my-special use').setAttribute('href', `img/icons.svg#${iconString}`);
    // icons.svg#icon-heart-outlined
};

export const toggleSpecLikeMenu = numSpecLikes => {
    elements.specLikesMenu.style.visibility = numSpecLikes > 0 ? 'visible' : 'hidden';
};
        ...
        <li>
            <a class="likes__link" href="#${specLike.id}">
                ...
                <div class="likes__data">
                    <h4 class="likes__name">${limitRecipeTitle(specLike.title)}</h4>
